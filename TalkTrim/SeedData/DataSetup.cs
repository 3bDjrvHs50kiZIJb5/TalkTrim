...
public static class DataSetup
{
    public static void Initialize(IServiceProvider serviceProvider)
    {
        ...
        {
            scope.ServiceProvider.GetService<SiteSettingsService>()?.InvalidateCache();
        }
    ...
    public static void SyncStructure(IFreeSql freeSql)
    {
        ...
        freeSql.CodeFirst.SyncStructure<Project>();
        freeSql.CodeFirst.SyncStructure<ProjectJob>();
